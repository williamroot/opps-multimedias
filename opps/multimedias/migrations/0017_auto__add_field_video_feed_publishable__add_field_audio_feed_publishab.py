...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.feed_publishable'
        db.add_column(u'multimedias_video', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Audio.feed_publishable'
        db.add_column(u'multimedias_audio', 'feed_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.feed_publishable'
        db.delete_column(u'multimedias_video', 'feed_publishable')

        # Deleting field 'Audio.feed_publishable'
        db.delete_column(u'multimedias_audio', 'feed_publishable')


    models = {
        u'accounts.customuser': {
            'Meta': {'object_name': 'CustomUser'},
            'accept_email_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'accept_mobile_phone_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'email_newsletter': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'db_index': 'True'}),
            ...
            'mobile_phone_newsletter': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'channels.channel': {
            ...
            'feed_publishable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
